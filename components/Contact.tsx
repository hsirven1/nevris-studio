  ...
  return (
    ...
    >
      <div className="gutter-x flex flex-col items-start py-16 md:items-center md:py-[clamp(4rem,10vh,6.5rem)] md:text-center">
        <p className="m-0 font-label text-[11px] tracking-[0.16em] text-ink-45 uppercase md:text-[12px]">
          {contact.eyebrow}
        </p>
        ...
        <button
          type="button"
          onClick={openContact}
          className="mt-6 rounded-full bg-ink px-7 py-3.5 font-label text-[12px] tracking-[0.14em] text-ground uppercase transition-colors hover:bg-accent md:mt-[clamp(1.75rem,4vh,2.5rem)] sm:px-8 sm:text-[13px]"
        >
          {contact.cta}
        </button>
      </div>
