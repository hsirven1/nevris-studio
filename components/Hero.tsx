...
export function Hero() {
  return (
    ...
    >
      ...
      {/* Headline — under the shape, slight compositional overlap */}
      <div className="relative z-[2] flex h-full min-h-[20rem] flex-col items-center justify-end pb-[clamp(1.25rem,4vh,2.25rem)] md:min-h-0 md:pb-[clamp(1.5rem,5vh,2.75rem)]">
        <div className="inline-flex -translate-y-[clamp(3.25rem,11vh,6.75rem)] flex-col items-stretch">
          <h1 className="type-hero-statement m-0 whitespace-nowrap text-center text-ink [text-shadow:0_0_28px_var(--color-ground),0_0_10px_var(--color-ground)]">
            From strategy to{" "}
